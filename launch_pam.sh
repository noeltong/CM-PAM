...
mpiexec --allow-run-as-root -n 4 python cm_train.py --training_mode consistency_training --target_ema_mode adaptive --start_ema 0.95 --scale_mode progressive --start_scales 2 --end_scales 200 --total_training_steps 500000 --loss_norm huber --lr_anneal_steps 0 --teacher_model_path "" --ema_rate 0.9999 --global_batch_size 64 --lr 0.00001 --schedule_sampler uniform --use_fp16 True --weight_decay 0.01 --weight_schedule uniform --dataset brain --image_size 128 --hidden_size 384 --num_heads 6